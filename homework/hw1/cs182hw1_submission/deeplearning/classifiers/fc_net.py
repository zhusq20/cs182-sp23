...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for l in range(self.num_layers - 1):
            out[l + 1], cache[l + 1] = affine_relu_forward(out[l], 
        ...
        for i in range(t):
            ...
            if i == 0:
                dx[t - i], dw[t - i], db[t - i] = affine_backward(dl_s, cache[t - i])
            else:
                dx[t - i], dw[t - i], db[t - i] = affine_relu_backward(dx[t - i + 1], cache[t - i])
            grads['W' + str(t - i)] = dw[t - i] + self.reg * self.params['W' + str(t - i)]
            grads['b' + str(t - i)] = db[t - i]
